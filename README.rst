...
Complete instructions on how to deploy DevStack with
Trove and Trove-Dashboard, please refer to the official `OpenStack documentation <https://docs.openstack.org/trove/latest/install/install-devstack.html>`_.
